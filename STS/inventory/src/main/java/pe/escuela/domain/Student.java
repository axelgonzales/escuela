...
public class Student {
	...
	public String getPosiUserBarba() {
		return posiUserBarba;
	}
	public void setPosiUserBarba(String posiUserBarba) {
		this.posiUserBarba = posiUserBarba;
	}
	public String getSenalesParticualres() {
		return senalesParticualres;
	}
	public void setSenalesParticualres(String senalesParticualres) {
		this.senalesParticualres = senalesParticualres;
	}
	...
	public String getEnjuiciado() {
		return enjuiciado;
	}
	public void setEnjuiciado(String enjuiciado) {
		this.enjuiciado = enjuiciado;
	}
